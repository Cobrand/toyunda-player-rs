...
pub fn real_position((displayer_width, displayer_height): (u32, u32),
                     ...
                     (object_width, object_height): (u32, u32))
                     -> (i32, i32) {
    ...
    match pos_x {
        PosX::Centered => object_pos.0 = (displayer_width / 2) as i32 - delta_anchor_x,
        PosX::FromLeft(value) => object_pos.0 = value as i32 - delta_anchor_x,
    ...
    match pos_y {
        PosY::Centered => object_pos.1 = (displayer_height / 2) as i32 - delta_anchor_y,
        PosY::FromTop(value) => object_pos.1 = value as i32 - delta_anchor_y,
