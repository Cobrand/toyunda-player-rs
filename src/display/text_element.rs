...
impl TextElement {
    pub fn blit(&self,
        ...
        match self.outline {
            Some(outline_color) => {
                ...
                let outline_surface = font_set.get_outline_font()
                    ...
                    .unwrap();
                outline_surface.blit(None, surface.deref_mut(), None)
                    .expect("Failed to blit Surfaces");
            }
            None => {}
        };
        ...
        Rect::new(origin.0,
                  origin.1,
                  outline_width * 2 + regular_w,
                  outline_width * 2 + regular_h)
    }
}
